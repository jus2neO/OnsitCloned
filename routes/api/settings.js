...
const Modelclass = require('../models/settings.js');
...
router.post('/', upload.single('photo'), async (req, res, next) => {
    data = { start: req.body.start, end: req.body.end, issaturdayopen: req.body.issaturdayopen, enabled: req.body.enabled }
...
router.put('/:id', upload.single('photo'), async (req, res, next) => {
    ...
    data = { start: req.body.start, end: req.body.end, slotlimit: req.body.slotlimit, issaturdayopen: req.body.issaturdayopen, enabled: req.body.enabled }
