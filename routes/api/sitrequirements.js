...
const Modelclass = require('../models/sitrequirements.js');

//get all sitrequirements
...
router.post('/',upload.single('photo'), async (req, res, next) => {
    data = {sitlevel: req.body.sitlevel, label: req.body.label, description: req.body.description,created: new Date(), enabled: true}
